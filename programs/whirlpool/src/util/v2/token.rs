...
pub fn transfer_from_owner_to_vault_v2<'info>(
    ...
    solana_program_v1_17_22::program::invoke_signed(&instruction, &account_infos, &[])?;
...
pub fn transfer_from_vault_to_owner_v2<'info>(
    ...
    solana_program_v1_17_22::program::invoke_signed(
        &instruction,
        &account_infos,
        &[&whirlpool.seeds()],
    )?;
...
mod fuzz_tests {
    ...
    struct SyscallStubs {}
    impl solana_program_v1_17_22::program_stubs::SyscallStubs for SyscallStubs {
    ...
    proptest! {
        ...
        fn test_calculate_transfer_fee_included_amount(
            ...
            // stub Clock
            solana_program_v1_17_22::program_stubs::set_syscall_stubs(Box::new(SyscallStubs {}));
